...
class BaseTrainer():
    def __init__(self, rank, cfg):
        ...
        self.max_batch_size = cfg['batch_size']
    ...
    def make_model(self, model_spec=None, load_sd=False):
        ...
        max_seq_length = model.max_seq_length + model.cls_token_num
        ...
        self.diagonal_mask = diagonal_mask.unsqueeze(0).repeat(self.max_batch_size  // dist.get_world_size(), 1, 1)
