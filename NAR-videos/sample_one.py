...
def sample_videos(
    ...
    for i, data in enumerate(pbar):
        ...
        bsz, seq_length = c.shape[0], sampled_seqs.shape[1] + larp_ar_model.cls_token_num
        ...
        _, loss = larp_ar_model(
            ...
            mask=larp_ar_model.diagonal_mask[:bsz, :seq_length ,:seq_length] # match (bsz, seq_length) of mask and sampled_seqs
        )
